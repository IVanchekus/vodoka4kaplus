...
Route::get('/month_costs', 'MainController@month_costs')->name('month_costs');
Route::post('/month_costs/check', 'MainController@month_costs_check');

Route::get('/pump_meter_records', 'MainController@pump_meter_records')->name('pump_meter_records');
Route::post('/pump_meter_records/check', 'MainController@pump_meter_records_check');
